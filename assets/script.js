...
async function chercherVille_func() {
  ...
  try {
    ...
    console.log(` Coordonnées : ${latitude}, ${longitude}`); console.log("Initialisation avec :", lat, long);
    //afficher les recherche dans le html
    const villeNomElem = document.querySelector(".ville-nom");
    if (villeNomElem) {
      villeNomElem.textContent = `${name}, ${country}`;
    }
...
function oncityWhereweare_func(latitude, longitude) {
